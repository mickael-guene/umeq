...
int syscall32_64(Sysnum no, uint32_t p0, uint32_t p1, uint32_t p2, uint32_t p3, uint32_t p4, uint32_t p5)
{
    ...
    switch(no) {
        ...
        case PR_mincore:
            ...
            break;
        case PR_ppoll:
            res = ppoll_s3264(p0, p1, p2, p3, p4);
            break;
        case PR_readv:
            res = readv_s3264(p0, p1, p2);
            break;
        case PR_signalfd4:
        ...
        case PR_timerfd_gettime:
            ...
            break;
        case PR_vmsplice:
            res = vmsplice_s3264(p0, p1, p2 , p3);
            break;
        case PR_waitid:
            res = waitid_s3264(p0, p1, p2, p3, p4);
            break;
