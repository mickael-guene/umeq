...
static void mk_call_void(struct arm_target *context, struct irInstructionAllocator *ir, char *name, struct irRegister *address, struct irRegister **params)
{
    ir->add_write_context_32(ir, mk_32(ir, context->pc), offsetof(struct arm_registers, helper_pc));
    ir->add_call_void(ir, name, address, params);
    ir->add_write_context_32(ir, mk_32(ir, 0), offsetof(struct arm_registers, helper_pc));
}

static struct irRegister *mk_call_32(struct arm_target *context, struct irInstructionAllocator *ir, char *name, struct irRegister *address, struct irRegister **params)
{
...
static struct irRegister *mk_call_64(struct arm_target *context, struct irInstructionAllocator *ir, char *name, struct irRegister *address, struct irRegister **params)
{
    struct irRegister *res;
...
static void dump_state(struct arm_target *context, struct irInstructionAllocator *ir)
{
    ...
    mk_call_void(context, ir, "arm_hlp_dump",
...
static void dump_state_and_assert(struct arm_target *context, struct irInstructionAllocator *ir)
{
    ...
    mk_call_void(context, ir, "arm_hlp_dump_and_assert",
...
static int mk_data_processing(struct arm_target *context, struct irInstructionAllocator *ir, int insn, struct irRegister *op2)
{
    ...
    if (s) {
        ...
        nextCpsr = mk_call_32(context, ir, "arm_hlp_compute_next_flags",
                                   ir->add_mov_const_64(ir, ptr_2_int(arm_hlp_compute_next_flags)),
                                   params);
    }
    switch(opcode) {
        case 0://and
...
static struct irRegister *mk_mul_flag_update(struct arm_target *context, struct irInstructionAllocator *ir, struct irRegister *res, struct irRegister *old_cpsr)
{
    ...
    return mk_call_32(context, ir, "arm_hlp_multiply_flag_update",
                           ir->add_mov_const_64(ir, ptr_2_int(arm_hlp_multiply_flag_update)),
                           param);
}
...
static int dis_umaal(struct arm_target *context, uint32_t insn, struct irInstructionAllocator *ir)
{
    ...
    mk_call_void(context, ir, "arm_hlp_umaal",
                           mk_64(ir, ptr_2_int(arm_hlp_umaal)),
                           params);
...
static int dis_strexd(struct arm_target *context, uint32_t insn, struct irInstructionAllocator *ir)
{
    ...
    result = mk_call_64(context, ir, "arm_hlp_strexd",
...
static int dis_halfword_mult_and_mult_acc_insn(struct arm_target *context, uint32_t insn, struct irInstructionAllocator *ir)
{
    ...
    mk_call_void(context, ir, "arm_hlp_halfword_mult_and_mult_acc",
                           ir->add_mov_const_64(ir, ptr_2_int(arm_hlp_halfword_mult_and_mult_acc)),
                           params);
...
static int dis_saturating_add_A_sub(struct arm_target *context, uint32_t insn, struct irInstructionAllocator *ir)
{
    ...
    mk_call_void(context, ir, "arm_hlp_dirty_saturating",
                           ir->add_mov_const_64(ir, ptr_2_int(arm_hlp_dirty_saturating)),
                           params);
...
static int dis_saturation(struct arm_target *context, uint32_t insn, struct irInstructionAllocator *ir)
{
    ...
    mk_call_void(context, ir, "arm_hlp_saturation",
                           ir->add_mov_const_64(ir, ptr_2_int(arm_hlp_saturation)),
                           params);
...
static int dis_signed_multiplies(struct arm_target *context, uint32_t insn, struct irInstructionAllocator *ir)
{
    ...
    mk_call_void(context, ir, "arm_hlp_signed_multiplies",
                           ir->add_mov_const_64(ir, ptr_2_int(arm_hlp_signed_multiplies)),
                           params);
...
static int dis_sum_absolute_difference(struct arm_target *context, uint32_t insn, struct irInstructionAllocator *ir)
{
    ...
    mk_call_void(context, ir, "arm_hlp_sum_absolute_difference",
                           ir->add_mov_const_64(ir, ptr_2_int(arm_hlp_sum_absolute_difference)),
                           params);
...
static int dis_signed_parallel(struct arm_target *context, uint32_t insn, struct irInstructionAllocator *ir)
{
    ...
    mk_call_void(context, ir, "arm_hlp_signed_parallel",
                           ir->add_mov_const_64(ir, ptr_2_int(arm_hlp_signed_parallel)),
                           params);
...
static int dis_unsigned_parallel(struct arm_target *context, uint32_t insn, struct irInstructionAllocator *ir)
{
    ...
    mk_call_void(context, ir, "arm_hlp_unsigned_parallel",
                           ir->add_mov_const_64(ir, ptr_2_int(arm_hlp_unsigned_parallel)),
                           params);
...
static int vdso_cmpxchg64(struct arm_target *context, struct irInstructionAllocator *ir)
{
    ...
    mk_call_void(context, ir, "arm_hlp_vdso_cmpxchg64",
                      ir->add_mov_const_64(ir, ptr_2_int(arm_hlp_vdso_cmpxchg64)),
                      param);
...
static int vdso_cmpxchg(struct arm_target *context, struct irInstructionAllocator *ir)
{
    ...
    mk_call_void(context, ir, "arm_hlp_vdso_cmpxchg",
                      ir->add_mov_const_64(ir, ptr_2_int(arm_hlp_vdso_cmpxchg)),
                      param);
...
void disassemble_arm_with_marker(struct arm_target *context, struct irInstructionAllocator *ir, uint64_t pc, int maxInsn)
{
    int i;
    int isExit = 0; //unconditionnal exit
    uint32_t *pc_ptr = (uint32_t *) g_2_h(pc);
