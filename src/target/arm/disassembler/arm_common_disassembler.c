...
static struct irRegister *read_fpscr(struct arm_target *context, struct irInstructionAllocator *ir)
{
    ...
    return mk_call_32(context, ir, "hlp_read_fpscr",
                        ir->add_mov_const_64(ir, ptr_2_int(hlp_read_fpscr)),
                        params);
}
...
static void write_fpscr(struct arm_target *context, struct irInstructionAllocator *ir, struct irRegister *value)
{
    ...
    mk_call_void(context, ir, "hlp_write_fpscr",
                        ir->add_mov_const_64(ir, ptr_2_int(hlp_write_fpscr)),
                        params);
}
...
static int dis_common_vldm(struct arm_target *context, uint32_t insn, struct irInstructionAllocator *ir)
{
    ...
    mk_call_void(context, ir, "hlp_arm_vldm",
                        ir->add_mov_const_64(ir, ptr_2_int(hlp_arm_vldm)),
                        params);
...
static int dis_common_vstm(struct arm_target *context, uint32_t insn, struct irInstructionAllocator *ir)
{
    ...
    mk_call_void(context, ir, "hlp_arm_vstm",
                        ir->add_mov_const_64(ir, ptr_2_int(hlp_arm_vstm)),
                        params);
...
static int dis_common_adv_simd_three_different_length_hlp(struct arm_target *context, uint32_t insn, struct irInstructionAllocator *ir)
{
    ...
    mk_call_void(context, ir, "hlp_common_adv_simd_three_different_length",
                        ir->add_mov_const_64(ir, ptr_2_int(hlp_common_adv_simd_three_different_length)),
                        params);
...
static int dis_common_adv_simd_three_same_length_hlp(struct arm_target *context, uint32_t insn, struct irInstructionAllocator *ir)
{
    ...
    mk_call_void(context, ir, "hlp_common_adv_simd_three_same_length",
                        ir->add_mov_const_64(ir, ptr_2_int(hlp_common_adv_simd_three_same_length)),
                        params);
...
static int dis_common_adv_simd_two_regs_misc_hlp(struct arm_target *context, uint32_t insn, struct irInstructionAllocator *ir)
{
    ...
    mk_call_void(context, ir, "hlp_common_adv_simd_two_regs_misc",
                        ir->add_mov_const_64(ir, ptr_2_int(hlp_common_adv_simd_two_regs_misc)),
                        params);
...
static int dis_common_adv_simd_vdup_arm_insn(struct arm_target *context, uint32_t insn, struct irInstructionAllocator *ir)
{
    ...
    mk_call_void(context, ir, "hlp_common_adv_simd_vdup_arm",
                        ir->add_mov_const_64(ir, ptr_2_int(hlp_common_adv_simd_vdup_arm)),
                        params);
...
static int dis_common_adv_simd_vmov_from_arm_insn(struct arm_target *context, uint32_t insn, struct irInstructionAllocator *ir)
{
    ...
    mk_call_void(context, ir, "hlp_common_adv_simd_vmov_from_arm",
                        ir->add_mov_const_64(ir, ptr_2_int(hlp_common_adv_simd_vmov_from_arm)),
                        params);
...
static int mk_common_vfp_data_processing_insn(struct arm_target *context, uint32_t insn, struct irInstructionAllocator *ir)
{
    ...
    mk_call_void(context, ir, "hlp_common_vfp_data_processing_insn",
                           ir->add_mov_const_64(ir, ptr_2_int(hlp_common_vfp_data_processing_insn)),
                           params);
...
static int dis_common_adv_simd_two_regs_and_scalar_insn(struct arm_target *context, uint32_t insn, struct irInstructionAllocator *ir)
{
    ...
    mk_call_void(context, ir, "hlp_common_adv_simd_two_regs_and_scalar",
                        ir->add_mov_const_64(ir, ptr_2_int(hlp_common_adv_simd_two_regs_and_scalar)),
                        params);
...
static int dis_common_adv_simd_vdup_scalar_insn(struct arm_target *context, uint32_t insn, struct irInstructionAllocator *ir)
{
    ...
    mk_call_void(context, ir, "hlp_common_adv_simd_vdup_scalar",
                        ir->add_mov_const_64(ir, ptr_2_int(hlp_common_adv_simd_vdup_scalar)),
                        params);
...
static int dis_common_adv_simd_vtbl_vtbx_insn(struct arm_target *context, uint32_t insn, struct irInstructionAllocator *ir)
{
    ...
    mk_call_void(context, ir, "hlp_common_adv_simd_vtbl_vtbx",
                        ir->add_mov_const_64(ir, ptr_2_int(hlp_common_adv_simd_vtbl_vtbx)),
                        params);
...
static int dis_common_adv_simd_vext_insn(struct arm_target *context, uint32_t insn, struct irInstructionAllocator *ir)
{
    ...
    mk_call_void(context, ir, "hlp_common_adv_simd_vext",
                        ir->add_mov_const_64(ir, ptr_2_int(hlp_common_adv_simd_vext)),
                        params);
...
static int dis_common_adv_simd_two_regs_and_shift_insn(struct arm_target *context, uint32_t insn, struct irInstructionAllocator *ir)
{
    ...
    mk_call_void(context, ir, "hlp_common_adv_simd_two_regs_and_shift",
                        ir->add_mov_const_64(ir, ptr_2_int(hlp_common_adv_simd_two_regs_and_shift)),
                        params);
...
static int dis_common_adv_simd_element_or_structure_load_store_insn(struct arm_target *context, uint32_t insn, struct irInstructionAllocator *ir)
{
    ...
    mk_call_void(context, ir, "hlp_common_adv_simd_element_or_structure_load_store",
                        ir->add_mov_const_64(ir, ptr_2_int(hlp_common_adv_simd_element_or_structure_load_store)),
                        params);
